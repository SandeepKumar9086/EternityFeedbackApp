...
<html>
	...
	<title>Eternity &mdash; Free Feedback Application</title>
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<meta name="description" content="Free Feedback Application" />
	<meta name="keywords" content="free feedback templates, free feedback for website and application" />
	<meta name="author" content="dev.eternity" />
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-12 text-right gtco-contact">
					<ul class="">
						<li><a href="#"><i class="ti-mobile"></i> +91 (0)855 49 27768 </a></li>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					<div class="display-t">
						<div class="display-tc">
							<h1 class="animate-box" data-animate-effect="fadeInUp">Take Your Business To The Next Level</h1>
							<h2 class="animate-box" data-animate-effect="fadeInUp">Free Feedback Application <em>by</em> <a href="http://gettemplates.co/" target="_blank">EternityTech.co</a></h2>
							<p class="animate-box" data-animate-effect="fadeInUp"><a href="#" class="btn btn-white btn-lg btn-outline">Sign-in</a></p>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="gtco-flex">
				<div class="feature feature-1 animate-box" data-animate-effect="fadeInUp">
					<div class="feature-inner">
						...
						<h3>Search</h3>
						<p>Look for what your customer says, get feedback learn and improve shortfall or showcase the guestbook. </p>
				...
				<div class="feature feature-2 animate-box" data-animate-effect="fadeInUp">
					<div class="feature-inner">
						...
						<h3>Announcdement</h3>
						<p>EternityTech brings you free feedback application. </p>
						<p><a href="#" class="btn btn-white btn-outline">Learn More</a></p>
					</div>
				</div>
				<div class="feature feature-3 animate-box" data-animate-effect="fadeInUp">
					<div class="feature-inner">
						...
						<h3>Setup</h3>
						<p>Step by step guide to do setup in 5 easy steps. </p>
						<p><a href="#" class="btn btn-white btn-outline">Learn More</a></p>
					</div>
				</div>
			</div>
		...
		<div class="gtco-container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
					<h2>Eternity Feedback Features</h2>
					<p>Control public and private feedback, showcase the guestbook, integrate with your website or mobile app.</p>
				</div>
			</div>
			<div class="row">
		...
		<div class="gtco-container">
			...
			<div class="row animate-box">
				<div class="owl-carousel owl-carousel-carousel">
					<div class="item">
						<img src="/resources/images/img_1.jpg" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
					</div>
					<div class="item">
						<img src="/resources/images/img_2.jpg" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
					</div>
					<div class="item">
						<img src="/resources/images/img_3.jpg" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
					</div>
					<div class="item">
						<img src="/resources/images/img_4.jpg" alt="Free HTML5 Bootstrap Template by GetTemplates.co">
					</div>
				</div>
			</div>
		</div>
